          ...
          <b-table-simple responsive align="middle" class="table-centered mb-0">
            ...
            <b-tbody>
              <b-tr>
                ...
                <b-td>This cell inherits <code>align: middle;</code> from the table</b-td>
                <b-td>This cell inherits <code>align: middle;</code> from the table</b-td>
                <b-td>This here is some placeholder text, intended to take up quite a bit of vertical space, to demonstrate how the vertical alignment works in the preceding cells. </b-td>
              </b-tr>
              <b-tr align="bottom">
              ...
              <tr class="table-active">
                <b-td>
                  <div class="d-flex align-items-center gap-1">
                    ...
                    <div class="d-block">
                      <h5 class="mb-0 d-flex align-items-center gap-1">Mary J. Germain<i class="bx bxs-badge-check text-success"></i></h5>
                    </div>
                  </div>
                </b-td>
