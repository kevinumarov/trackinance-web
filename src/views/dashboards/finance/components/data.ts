...
import type { RevenueSourceTableType, TransactionsTableType } from '@/views/dashboards/finance/components/types'
...
import { getDateAndTime } from '@/helpers/others'
...
export const revenueCart: ApexChartType = {
  height: 280,
  type: 'line',
  series: [
    {
...
export const expensesChart: ApexChartType = {
  height: 280,
  type: 'bar',
  series: [
    {
...
export const revenueSourceChart: ApexChartType = {
  height: 205,
  type: 'donut',
  series: [140, 125, 85],
  options: {
