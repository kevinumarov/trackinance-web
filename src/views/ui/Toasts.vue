<template>
  <DefaultLayout>
    ...
    <b-row>
      <b-col xl="9">
        <UIComponentCard title="Basic Examples" id="basic_examples" caption="Toasts are as flexible as you need and have very little required markup. At a minimum, we require a single element to contain your “toasted” content and strongly encourage a dismiss button.">
        ...
        <UIComponentCard title="Live example" id="live_example" caption="Click the button below to show a toast (positioned with our utilities in the lower right corner) that has been hidden by default.">
          <b-button variant="primary" id="liveToastDefaultBtn"> Show live toast </b-button>

          <div class="toast-container position-fixed bottom-0 end-0 p-3">
            <b-toast v-model="liveExample" :noCloseButton="true">
              <template #title>
                <div class="auth-logo">
                  <img class="logo-dark" :src="logoDark" alt="logo-dark" height="18" />
                  <img class="logo-light" :src="logoLight" alt="logo-light" height="18" />
        ...
        <UIComponentCard title="Default Buttons" id="default_buttons" caption="Toasts are as flexible as you need and have very little required markup. At a minimum, we require a single element to contain your “toasted” content and strongly encourage a dismiss button.">
        ...
        <UIComponentCard title="Custom Content" id="custom_content" caption="Alternatively, you can also add additional controls and components to toasts.">
          <b-row>
            <b-col md="6">
        ...
        <UIComponentCard title="Transcluent" id="transcluent" caption="Toasts are slightly translucent, too, so they blend over whatever they might appear over. For browsers that support the backdrop-filter CSS property, we’ll also attempt to blur the elements under a toast.">
