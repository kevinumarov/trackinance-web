<template>
  <DefaultLayout>
    <PageBreadcrumb title="Input Mask" subtitle="Form" />

    <b-row>
      <b-col xl="12">
        <b-card no-body>
          <b-card-body>
            <b-card-title tag="h5" class="anchor" id="default"> Input Masks<a class="anchor-link" href="#default">#</a> </b-card-title>
                ...
                <b-col md="6">
                  <b-form action="#">
                    ...
                    <div class="mb-3">
                      ...
                      <InputMask id="money-2" mask="#.##9,99" />
                ...
                <b-col md="6">
                  <b-form>
                    ...
                    <div class="mb-3">
                      ...
                      <InputMask id="code-telephone" mask="(99) 9999-9999" />
                    ...
                    <div class="mb-3">
                      <label class="form-label">São Paulo Cellphones</label>
                      <InputMask id="sao-paulo-telephone" mask="(99) 99999-9999" />
