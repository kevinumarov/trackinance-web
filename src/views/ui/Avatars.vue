<template>
  <DefaultLayout>
    <PageBreadcrumb title="Avatars" subtitle="Base UI" />
    <b-row>
      <b-col xl="9">
        <b-card no-body>
          <b-card-body>
            <b-card-title tag="h5" class="mb-1 anchor" id="basic-example"> Basic Example <a class="anchor-link" href="#basic-example">#</a> </b-card-title>
        ...
        <b-card no-body>
          <b-card-body>
            <b-card-title tag="h5" class="mb-1 anchor" id="rounded-circle"> Rounded Circle<a class="anchor-link" href="#rounded-circle">#</a> </b-card-title>
        ...
        <b-card no-body>
          <b-card-body>
            <b-card-title tag="h5" class="mb-1 anchor" id="images-shapes"> Images Shapes<a class="anchor-link" href="#">#</a> </b-card-title>
