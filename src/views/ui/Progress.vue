<template>
  <DefaultLayout>
    ...
    <b-row>
      <b-col xl="9">
        <UIComponentCard title="How it works" id="how-works" caption="A progress bar can be used to show a user how far along he/she is in a process.">
        ...
        <UIComponentCard title="Backgrounds Color" id="backgrounds-color" caption="Use background utility classes to change the appearance of individual progress bars.">
