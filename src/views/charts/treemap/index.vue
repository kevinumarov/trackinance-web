<template>
  <DefaultLayout>
    <PageBreadcrumb title="Treemap Charts" subtitle="Charts" />
    <b-row>
      <b-col xl="9">
...
import { basicTreemapChart, multipleSeriesTreemapChart, distributedTreemapChart, colorRangeTreemapChart } from '@/views/charts/treemap/data'
