<template>
  <DefaultLayout>
    <PageBreadcrumb title="Nav Tabs" subtitle="Base UI" />
    ...
    <b-row>
      <b-col xl="9">
          ...
          <b-tabs content-class="text-muted" class="mt-3">
            ...
            <b-tab id="profile" active>
              ...
              <p class="mb-0">
                ...
                lingue es plu simplic e regulari quam ti del coalescent lingues. Li nov lingua franca va esser plu simplic e regulari quam li existent Europan lingues.
              </p>
            </b-tab>
            <b-tab id="settings">
              <template #title>
        ...
        <UIComponentCard title="Pills Justified" id="modal-position">
          <b-tabs class="mt-3" content-class="pt-2 text-muted" nav-class="p-1" nav-wrapper-class="d-flex flex-wrap gap-2" justified pills>
            <b-tab id="home">
              <template #title>
                <span class="d-block d-sm-none"><i class="bx bx-home"></i></span>
                <span class="d-none d-sm-block">Home</span>
        ...
        <UIComponentCard title="Tabs Vertical Left" id="toggle-between-modals">
          <b-row class="mt-3">
            <b-tabs content-class="pt-0" nav-class="flex-column" nav-wrapper-class="col-sm-3 mb-2 mb-sm-0" pills vertical justified>
              ...
              <b-tab title="Profile" id="profile">
                <p class="mb-0">
                  Li Europan lingues es membres del sam familie. Lor separat existentie es un myth. Por scientie, musica, sport etc, litot Europa usa li sam vocabular. Li lingues differe solmen in li grammatica, li pronunciation e li plu commun vocabules. Omnicos directe al desirabilite de un nov lingua franca: On refusa continuar payar custosi traductores. At solmen va esser necessi far uniform grammatica, pronunciation e plu sommun paroles. Ma quande lingues coalesce, li grammatica del
                  resultant lingue es plu simplic e regulari quam ti del coalescent lingues. Li nov lingua franca va esser plu simplic e regulari quam li existent Europan lingues.
                </p>
              </b-tab>
        ...
        <UIComponentCard title="Tabs Vertical Right" id="varying-modal-content">
          <b-row class="mt-3">
            <b-tabs content-class="pt-0" nav-class="flex-column" nav-wrapper-class="col-sm-3 ms-2" pills vertical justified :end="true">
              <b-tab title="Home" id="home" active>
                <p class="mb-0">
                  Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non
                  numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem?
