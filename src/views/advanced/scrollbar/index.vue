<template>
  <DefaultLayout>
    <PageBreadcrumb title="Scrollbar" subtitle="Advanced UI" />
    ...
    <b-row>
      <b-col xl="9">
        <b-card no-body>
          <b-card-body>
            ...
            <div class="border rounded py-3 mt-3">
              <simplebar class="px-3" data-simplebar style="max-height: 250px">
        ...
        <b-card no-body>
          <b-card-body>
            <b-card-title tag="h5" class="mb-1 anchor" id="rtl">
              RTL Position
              <a class="anchor-link" href="#rtl">#</a>
            </b-card-title>

            <div class="border rounded py-3 mt-3">
              <simplebar class="px-3" data-simplebar data-simplebar-direction="rtl" style="max-height: 250px">
                SimpleBar does only one thing: replace the browser's default scrollbar with a custom CSS-styled one without losing performances. Unlike some popular plugins, SimpleBar doesn't mimic scroll with Javascript, causing janks and strange scrolling behaviours... You keep the awesomeness of native scrolling...with a custom scrollbar!
                <p>
                  SimpleBar
                  <strong>does NOT implement a custom scroll behaviour</strong>. It keeps the
        ...
        <b-card no-body>
          <b-card-body>
            <b-card-title tag="h5" class="mb-1 anchor" id="size">
              Scroll Size
              <a class="anchor-link" href="#size">#</a>
            </b-card-title>

            <div class="border rounded py-3 mt-3">
              <simplebar class="px-3" data-simplebar data-simplebar-lg style="max-height: 250px">
                SimpleBar does only one thing: replace the browser's default scrollbar with a custom CSS-styled one without losing performances. Unlike some popular plugins, SimpleBar doesn't mimic scroll with Javascript, causing janks and strange scrolling behaviours... You keep the awesomeness of native scrolling...with a custom scrollbar!
                <p>
                  SimpleBar
                  <strong>does NOT implement a custom scroll behaviour</strong>. It keeps the
        ...
        <b-card no-body>
          <b-card-body>
            <b-card-title tag="h5" class="mb-1 anchor" id="color">
              Scroll Color
              <a class="anchor-link" href="#color">#</a>
            </b-card-title>

            <div class="border rounded py-3 mt-3">
              <simplebar class="px-3" data-simplebar data-simplebar-primary style="max-height: 250px">
                SimpleBar does only one thing: replace the browser's default scrollbar with a custom CSS-styled one without losing performances. Unlike some popular plugins, SimpleBar doesn't mimic scroll with Javascript, causing janks and strange scrolling behaviours... You keep the awesomeness of native scrolling...with a custom scrollbar!
                <p>
                  SimpleBar
                  <strong>does NOT implement a custom scroll behaviour</strong>. It keeps the
