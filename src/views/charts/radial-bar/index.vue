<template>
  <DefaultLayout>
    <PageBreadcrumb title="RadialBar Charts" subtitle="Charts" />
    <b-row>
      <b-col xl="9">
...
import { basicRadialBarChart, multipleRadialBarsChart, customAngleChart, circleWithImageChart, strokedCircularGuageChart, gradientCircularChart, semiCircleGaugeChart } from '@/views/charts/radial-bar/data'
