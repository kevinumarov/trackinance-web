<template>
  <DefaultLayout>
    <PageBreadcrumb title="GridJs" subtitle="Tables" />
    ...
    <b-row>
      <b-col xl="10">
        ...
        <UIComponentCard id="sorting" title="Search">
...
import { basicTableOptions, fixedHeaderTableOptions, hiddenColumnsTableOptions, loadingStateTableOptions, paginationTableOptions, searchTableOptions, sortingTableOptions } from '@/views/tables/gridjs/components/data'
