  ...
  <DefaultLayout>
    ...
    <b-row>
      <b-col cols="12">
              ...
              <b-col xl="3">
                ...
                <div id="external-events">
                  ...
                  <template v-for="(event, idx) in externalEvents" :key="idx">
                    <div :class="`external-event bg-soft-${event.className} text-${event.className}`" :data-class="`bg-${event.className}`">
        ...
        <b-modal v-model="modal" :title="isEditEvent ? 'Edit Event' : 'Add Event'" header-class="p-3 border-bottom-0" body-class="px-3 pb-3 pt-0" hide-footer>
          <b-form @submit.prevent="handleVuelidateSubmit">
            ...
            <b-row>
              <b-col cols="6">
                <b-button type="button" variant="danger" id="btn-delete-event" @click="deleteEvent" v-if="isEditEvent"> Delete </b-button>
              </b-col>
...
import { externalEvents, options, initialEvents } from '@/views/calendar/schedule/components/data'
