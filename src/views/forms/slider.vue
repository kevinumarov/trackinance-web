<template>
  <DefaultLayout>
    <PageBreadcrumb title="Slider" subtitle="Form" />

    <b-row>
      <b-col xl="9">
        <b-card no-body>
          <b-card-body>
            <b-card-title tag="h5" class="mb-3 anchor" id="basic-range"> Basic Range Slider<a class="anchor-link" href="#basic-range">#</a> </b-card-title>
        ...
        <b-card no-body>
          <b-card-body>
            <b-card-title tag="h5" class="mb-3 anchor" id="vertical-range"> Vertical Range Slider<a class="anchor-link" href="#vertical-range">#</a> </b-card-title>
        ...
        <b-card no-body>
          <b-card-body>
            <b-card-title tag="h5" class="mb-3 anchor" id="multi-range"> Multi Elements Range<a class="anchor-link" href="#multi-range">#</a> </b-card-title>
        ...
        <b-card no-body>
          <b-card-body>
            <b-card-title tag="h5" class="mb-3 anchor" id="colorpicker-range"> Colorpicker<a class="anchor-link" href="#colorpicker-range">#</a> </b-card-title>
        ...
        <b-card no-body>
          <b-card-body>
            <b-card-title tag="h5" class="mb-3 anchor" id="value-range"> Value Range Slider<a class="anchor-link" href="#value-range">#</a> </b-card-title>
        ...
        <b-card no-body>
          <b-card-body>
            <b-card-title tag="h5" class="mb-3 anchor" id="locking-together"> Locking Sliders Together<a class="anchor-link" href="#locking-together">#</a> </b-card-title>
        ...
        <b-card no-body>
          <b-card-body>
            <b-card-title tag="h5" class="mb-3 anchor" id="tooltip"> Tooltip<a class="anchor-link" href="#tooltip">#</a> </b-card-title>
        ...
        <b-card no-body>
          <b-card-body>
            <b-card-title tag="h5" class="mb-3 anchor" id="soft-limits">
              Soft Limits
              <a class="anchor-link" href="#soft-limits">#</a>
            </b-card-title>
