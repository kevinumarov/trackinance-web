<template>
  <b-offcanvas placement="end" class="border-0" id="activity-offcanvas" header-class="p-0" body-class="p-0" style="max-width: 450px; width: 100%">
    <template v-slot:header>
      <div class="d-flex align-items-center bg-primary p-3 w-100">
        <h5 class="text-white m-0 fw-semibold">Activity Stream</h5>
        <button type="button" class="btn-close btn-close-white ms-auto" v-b-toggle="'activity-offcanvas'"></button>
      </div>
    </template>

    <div class="p-0">
      <simplebar data-simplebar class="h-100 p-4">
        <div class="position-relative ms-2">
            ...
            <div class="mb-4">
              ...
              <div class="ms-2">
                ...
                <div class="bg-light bg-opacity-50 rounded-2 p-2">
                  <b-row>
                    <b-col lg="6" class="border-end border-light">
                    ...
                    <b-col lg="6">
                      <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="#!" class="text-dark fw-medium">trackinance.docs</a>
                      </div>
                    </b-col>
                  </b-row>
                </div>
          ...
          <div class="position-relative ps-4">
            <div class="mb-4">
              ...
              <div class="ms-2">
                <h5 class="mb-1 text-dark fw-semibold fs-15 lh-base">Project Status</h5>
                <p class="d-flex align-items-center mb-0">
                  Marked<span class="d-flex align-items-center text-primary mx-1">
                    <Icon icon="iconamoon:file-light" />
                    Design
                  </span>
                  as
                  <span class="badge bg-success-subtle text-success px-2 py-1 ms-1">Completed</span>
                </p>
                <div class="d-flex align-items-center gap-3 mt-1 bg-light bg-opacity-50 p-2 rounded-2">
                  <a href="#!" class="fw-medium text-dark">UI/UX Figma Design</a>
                  <div class="ms-auto">
                    <a href="#!" class="fw-medium text-primary fs-18" v-b-tooltip.hover.bottom="'Download'">
            ...
            <div class="mb-4">
              ...
              <div class="ms-2">
                <h5 class="mb-1 text-dark fw-semibold fs-15">
                  Trackinance Application UI v2.0.0
                  <span class="badge bg-primary-subtle text-primary px-2 py-1 ms-1"> Latest </span>
                </h5>
          ...
          <div class="position-relative ps-4">
            <div class="mb-4">
              <span class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20">
                <img :src="avatar7" alt="avatar-5" class="avatar-sm rounded-circle" />
              </span>
              <div class="ms-2">
                <h5 class="mb-0 text-dark fw-semibold fs-15 lh-base">Alex Smith Attached Photos</h5>
                <b-row class="g-2 mt-2">
                  <b-col lg="4">
                    <a href="#!">
                      <img :src="small6" alt="" class="img-fluid rounded" />
                    </a>
                  </b-col>
                  <b-col lg="4">
                    <a href="#!">
          ...
          <div class="position-relative ps-4">
            <div class="mb-4">
              <span class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20">
                <img :src="avatar6" alt="avatar-5" class="avatar-sm rounded-circle" />
              </span>
              <div class="ms-2">
                <h5 class="mb-0 text-dark fw-semibold fs-15 lh-base">Rebecca J. added a new team member</h5>
                <p class="d-flex align-items-center gap-1">
                  <Icon icon="iconamoon:check-circle-1-duotone" class="text-success" />
          ...
          <div class="position-relative ps-4">
            <div class="mb-4">
              ...
              <div class="ms-2">
                <h5 class="mb-0 text-dark fw-semibold fs-15 lh-base">Achievements</h5>
                <p class="d-flex align-items-center gap-1 mt-1">
                  Earned a
                  <Icon icon="iconamoon:certificate-badge-duotone" class="text-danger fs-20" />
                  " Best Product Award"
                </p>
