<template>
  <DefaultLayout>
    <PageBreadcrumb title="Widgets" subtitle="Trackinance" />

    <b-row>
      <div v-for="(item, idx) in statistics1" :key="idx" class="col-xl" :class="idx === 4 ? 'col-lg-6 col-md-12' : idx === 3 ? 'col-lg-6 col-md-6' : 'col-lg-4 col-md-6'">
    ...
    <b-row>
      <b-col md="6" xl="3" v-for="(item, idx) in statistics2" :key="idx">
        ...
        <b-card no-body>
          <div class="p-0">
            <b-row class="g-0">
              ...
              <b-col lg="8" class="border-start border-5">
                <div class="p-3">
    ...
    <b-row>
      <b-col md="6" xl="3" v-for="(item, idx) in statistics3" :key="idx">
...
import { statistics1, statistics2, statistics3, conversionsChart, performanceChart } from '@/views/widgets/components/data'

import { ref } from 'vue'

const performanceAlert = ref<boolean>(true)
</script>
