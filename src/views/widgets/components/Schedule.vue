<template>
  <b-card no-body>
    <b-card-body>
      <b-dropdown class="float-end" no-caret toggle-class="p-0" :variant="null">
        <template v-slot:button-content>
          <a href="javascript:void(0);" class="dropdown-toggle arrow-none">
            <i class="bx bx-dots-vertical-rounded fs-18 text-dark mb-1"></i>
          </a>
        </template>

        <b-dropdown-item> <i class="bx bx-list-ul me-2"></i>To Do </b-dropdown-item>
        <b-dropdown-item> <i class="bx bx-line-chart me-2"></i>In Progress </b-dropdown-item>
        <b-dropdown-item> <i class="bx bx-check-square me-2"></i>Completed </b-dropdown-item>
      </b-dropdown>
