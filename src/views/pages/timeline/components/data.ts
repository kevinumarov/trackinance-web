import type { TimelineType } from '@/views/pages/timeline/components/types'
...
export const timelineData: TimelineType[] = [
  {
    ...
    events: [
      ...
      {
        side: 'left',
        title: 'We released new version of our theme Trackinance.',
...
export const leftTimeLine: TimelineType[] = [
  ...
  },
  {
    ...
    events: [
      ...
      {
        title: 'First release of Trackinance admin dashboard template',
        description: 'Outdoor visit at California State Route 85 with John Boltana & Harry Piterson regarding to setup a new show room.'
      }
    ]
  }
