        ...
        <b-card no-body class="position-relative overflow-hidden h-100">
          <div class="p-3">
            <div class="d-flex flex-wrap gap-1">
              <b-button variant="light" class="d-xxl-none d-flex align-items-center px-2 me-2" type="button" @click="showEmailSidebar = !showEmailSidebar">
          ...
          <div class="tab-content pt-0" id="email-tabContent">
            <div class="tab-pane fade" id="email-inbox" :class="['primaryMail', 'socialMail', 'PromotionsMail', 'updatesMail', 'forumsMail', 'email-inbox'].includes(showTab) && 'show active'">
              <div>
                <ul class="nav nav-tabs nav-justified">
                  <li class="nav-item">
                    <a href="#" class="nav-link d-flex align-items-center" :class="['primaryMail', 'email-inbox'].includes(showTab) && 'active'" @click="filterMails('', 'primaryMail')">
                      <span class="me-2"><i class="bx bxs-inbox fs-18"></i></span>
                      <span class="d-none d-md-block">Primary</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link d-flex align-items-center" :class="showTab === 'socialMail' && 'active'" @click="filterMails('social', 'socialMail')">
                      <span class="me-2"><i class="bx bxs-group fs-18"></i></span>
                      <span class="d-none d-md-block">Social</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link d-flex align-items-center" :class="showTab === 'PromotionsMail' && 'active'" @click="filterMails('promotions', 'PromotionsMail')">
                      <span class="me-2"><i class="bx bxs-purchase-tag fs-18"></i></span>
                      <span class="d-none d-md-block">Promotions</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link d-flex align-items-center" :class="showTab === 'updatesMail' && 'active'" @click="filterMails('updates', 'updatesMail')">
                      <span class="me-2"><i class="bx bxs-info-circle fs-18"></i></span>
                      <span class="d-none d-md-block">Updates</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link d-flex align-items-center" :class="showTab === 'forumsMail' && 'active'" @click="filterMails('forums', 'forumsMail')">
                ...
                <div class="tab-content text-muted pt-0">
                  <div class="tab-pane" id="primaryMail" :class="['primaryMail', 'email-inbox'].includes(showTab) && 'show active'">
            ...
            <template v-for="(tab, idx) in emailTabs" :key="idx">
              <TabPane :tab="tab" :filteredMails="filteredMails" :showTab="showTab" :toggleReadOffcanvas="toggleReadOffcanvas" />
            </template>
          </div>
...
import type { EmailType } from '@/views/apps/email/components/types'
...
const taskDetail = `<h3>This is an Air-mode editable area.</h3>
                    <p><br></p>
                    <ul>
