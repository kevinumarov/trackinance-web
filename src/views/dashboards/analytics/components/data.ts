...
import type { SessionByBrowserType, SessionType, TopPagesTableType } from '@/views/dashboards/analytics/components/types'
...
export const topPagesTableData: TopPagesTableType = {
  ...
  body: [
    {
      pagePath: 'trackinance/dashboard.html',
      pageViews: 4265,
      avgTimeOnPage: '09m:45s',
      exitRate: 20.4
    },
    {
      pagePath: 'trackinance/chat.html',
      pageViews: 2584,
      avgTimeOnPage: '05m:02s',
      exitRate: 12.25
    },
    {
      pagePath: 'trackinance/auth-login.html',
      pageViews: 3369,
      avgTimeOnPage: '04m:25s',
      exitRate: 5.2
    },
    {
      pagePath: 'trackinance/email.html',
      pageViews: 985,
      avgTimeOnPage: '02m:03s',
      exitRate: 64.2
    },
    {
      pagePath: 'trackinance/social.html',
      pageViews: 653,
